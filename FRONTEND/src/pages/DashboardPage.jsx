      ...
      <div className="relative z-10 w-full max-w-6xl bg-white/5 backdrop-blur-md border border-white/10 shadow-[0_0_25px_rgba(255,255,255,0.06)] rounded-2xl p-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex gap-3">
            <Button as={Link} to="/my-registrations" variant="outline" className="font-semibold">
              <svg className="w-5 h-5 mr-2 -ml-1 inline-block text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              My Registrations
            </Button>
